...
$ python task_3_3.py --help
Usage: task_3_3.py [OPTIONS] COMMAND [ARGS]...
...
$ python task_3_3.py config --help
Usage: task_3_3.py config [OPTIONS] COMMANDS
...
$ python task_3_3.py ping --help
Usage: task_3_3.py ping [OPTIONS]
...
$ python task_3_3.py show --help
Usage: task_3_3.py show [OPTIONS] COMMAND
...
$ python task_3_3.py -y devices.yaml config config_commands.txt
...
$ python task_3_3.py -y devices.yaml ping
...
$ python task_3_3.py -y devices.yaml show "sh clock"
...
$ python task_3_3.py -y devices.yaml show "sh ip int br" -p -o result.yaml
$ python task_3_3.py -y devices.yaml show "sh ip int br" -o result.txt""
